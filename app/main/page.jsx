...
const Main = () => {
  ...
  {/* Dismiss button */}
  <button
    onClick={() => setFullscreen(false)} // Example action
  ...
  <div className="flex flex-col lg:flex-row items-center lg:justify-between text-center lg:text-left gap-4">
    ...
    <button
      ...
      className="text-lg font-semibold cursor-pointer px-6 py-3 rounded-xl bg-gradient-to-r from-green-500 to-yellow-500 text-white hover:scale-105 hover:shadow-xl transition-transform duration-300"
    >
      Open Recipe
    </button>
  </div>
